...
function initSliders() {
  ...
  if (document.querySelector(".our-best__slider")) {
    new Swiper(".our-best__slider", {
      // <- Вказуємо склас потрібного слайдера
      // Підключаємо модулі слайдера
      // для конкретного випадку
      modules: [Navigation, Pagination],
      ...
      */
      // Пагінація
      pagination: {
        el: ".slider-our-best__dots-pagination",
        clickable: true
      },
      // Скроллбар
      /*
      ...
      */
      // Кнопки "вліво/вправо"
      navigation: {
        prevEl: ".slider-our-best__arrow-prev",
        nextEl: ".slider-our-best__arrow-next"
      },
      // Брейкпоінти
      breakpoints: {
        // 480: {
      ...
      on: {
        init: function(swiper) {
          const fractionEl = document.querySelector(".slider-our-best__fraction-pagination");
          if (fractionEl) {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  menuButtons.forEach((button) => {
    button.addEventListener("click", (e) => {
      e.stopPropagation();
      const parentItem = button.closest(".menu__item");
      const subList = parentItem.querySelector(".menu__sub-list");
      const isOpen = subList.classList.contains("menu__sub-list--open");
      closeAllSubMenus();
      if (!isOpen) {
        openSubMenu(subList);
      }
  ...
  function openSubMenu(subList) {
    subList.classList.add("menu__sub-list--open");
    subList.style.maxHeight = subList.scrollHeight + "px";
    subList.addEventListener("transitionend", function handler(e) {
  ...
  function closeAllSubMenus() {
    document.querySelectorAll(".menu__sub-list--open").forEach((subList) => {
      subList.style.maxHeight = subList.scrollHeight + "px";
      requestAnimationFrame(() => {
...
if (searchWrapper) {
  ...
  if (searchBtn && searchInput) {
    ...
    console.warn("Один або обидва елементи .header__search-icon або .header__search-input не знайдено в .header__search.");
  }
} else {
  console.warn("Елемент .header__search не знайдено. Функціонал пошуку не буде активований.");
}
